...
const sizes = {
  sm: "sm:pb-[12px] md:pb-[15px] pb-[23px] md:pt-[11px] pt-[16px] sm:pt-[8px] md:px-[11px] sm:px-[15px] px-[16px]",
};
        ...
        <Select
          ...
          styles={{
            ...
            option: (provided, state) => ({
              ...
              backgroundColor: state.isSelected && "#5f545f7d",
              "&:hover": { backgroundColor: "#5f545f7d", color: "#545f7d" },
            }),
